...
// PanicSite — точка восстановления паники: аргумент хука WithPanicHook и значение
...
const (
	...
	// PanicSiteMessageSkipped — паника внутри хука WithSkipHook.
	// Трактуется как «хук не забрал сообщение».
	PanicSiteMessageSkipped PanicSite = "on_message_skipped"
	// PanicSitePanicHook — паника внутри самого хука WithPanicHook. Единственное
...
// вызывающему по его же стеку. Хук WithPanicHook поэтому тоже вызывается только
// консьюмером.
//
