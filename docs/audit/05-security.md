...
**Статус волны 2: сама утечка НЕ исправлена — исправление в волне 3. Но обе её ветки теперь
...
Сенсоры зелёные **пока утечка есть**: они утверждают наличие пароля в выводе. Каждый падает с
сообщением, объясняющим, что его нужно перевернуть, когда правка будет сделана. Это осознанный
выбор — тест, который сейчас нельзя написать «как надо», лучше держать перевёрнутым, чем не иметь
