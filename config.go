...
type Producer struct {
	// RequiredAcks: 0 = NoACK, 1 = LeaderACK, -1 = AllACK
	...
	BatchBytes   int           `yaml:"batch_bytes"             env-default:"1048576"` // 1 MB
...
type Consumer struct {
	...
	MaxBytes          int           `yaml:"max_bytes"               env-default:"10485760"` // 10 MB
